...
struct PostEntry {
    ...
    void (*PostEntryformatEntrysuccc)(struct PostEntry * , struct userPost**, char*, char*, char*);
    void (*PostEntryreadInputccc)(struct PostEntry * , char*, char*, char*);

    void (*PostEntrygetTimeDatesu)(struct PostEntry * , struct userPost**);

    void (*PostEntrysubmitPostsu)(struct PostEntry * , struct userPost*);
};void PostEntryformatEntrysuccc(struct PostEntry * tempStruct,struct userPost** myUserPost, char* nameToAdd, char* streamName, char* textToAdd)
    {
...
void PostEntrysubmitPostsu(struct PostEntry * tempStruct,struct userPost* myUserPost)
    {
        updateStream(myUserPost);
    }
void constructorPostEntry(struct PostEntry * tempStruct) {
tempStruct->PostEntryformatEntrysuccc = PostEntryformatEntrysuccc;
tempStruct->PostEntryreadInputccc = PostEntryreadInputccc;
tempStruct->PostEntrygetTimeDatesu = PostEntrygetTimeDatesu;
tempStruct->PostEntrysubmitPostsu = PostEntrysubmitPostsu;
}
...
constructorPostEntry(&myPostEntry);
    myPostEntry.PostEntryreadInputccc(&myPostEntry,textReader, streamName, myName);
    ...
    myPostEntry.PostEntrysubmitPostsu(&myPostEntry,myUserPost);
